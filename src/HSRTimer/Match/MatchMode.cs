...
namespace HSRTimer
{
    ...
    /// through <see cref="HSRTimerApi"/> (TwilightCore in production, console
    ...
    public static class MatchMode
    {
        ...
        public static void Enter()
        {
            ...
            if (cfg == null)
            {
                Plugin.Logger.LogWarning("HSRTimer: match mode enter ignored — config not ready.");
                return;
            }
            _savedTags.Clear();
            ...
            Plugin.Logger.LogInfo("HSRTimer: match mode entered (tags snapshotted).");
        }
        ...
        public static void Exit()
        {
            ...
            Active = false;
            TimerCore.Instance?.RefreshOptions();
            Plugin.Logger.LogInfo("HSRTimer: match mode exited (user tags restored).");
        }
